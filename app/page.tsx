...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center">
        ...
        />
          <div className="flex flex-col items-center justify-center space-y-2">
            ...
            <h2 className="text-xl md:text-2xl text-center text-gray-700 max-w-2xl z-20">
              Define the tokens needed to access your repositories and grant roles based on on-chain data.
            </h2>
            <Link href="/">
            ...
            <a href="#reward"  className="z-20 mt-4 px-8 py-2 select-none text-xs md:text-sm bg-white text-black rounded-md cursor-pointer transition-transform hover:scale-105">
                But there's more..
            </a>
          </div>
        </div>
      ...
      >
        ...
        />
          <div className="flex flex-col items-center justify-center space-y-2">
            ...
            <h2 className="text-xl md:text-2xl text-center text-gray-300 max-w-2xl z-20">
              A Soulbound ERC721Vote for your contributors to explore new governance horizons.
            </h2>
            <Link href="/">
      ...
      >
        <p><span className="font-bold">GitGate</span> - Made with ❤️ @ETHLisbon Hackaton.</p>
      </div>
    </div>
  );
}
