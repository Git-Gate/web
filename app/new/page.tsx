    ...
    return (
        <div className="h-screen max-w-3xl mx-auto flex flex-col items-center justify-center space-y-4">
            <h1 className="text-3xl md:text-5xl text-center font-extrabold z-20">
                <p>🎉</p>
                <p className="mt-4">Congratulations! You repository is now tokenized!</p>
            </h1>
        ...
        <div className="h-screen w-full">
            ...
            </div>
            {
                selectedRepo && <div className="py-8">
                    <RequirementsTable onClick={() => setOpen(true)} tokenGroups={tokenGroups} removeToken={(type: string, idx: number) => removeToken(type, idx)} />
                    <div className="p-8">
            ...
            <NewRequirementSlide open={open} setOpen={setOpen} submitRequirement={(requirement) => addToken(requirement)} />
        </div>
        </>
    )
}