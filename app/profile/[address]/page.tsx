    ...
    return (
        <div className="relative">
            ...
            <div className="flex flex-col items-center space-y-4 py-36">
                <img alt="User profile" className='rounded-full h-48 w-48' src={user.avatarUrl || "https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp"} />
                <h3 className='font-bold text-2xl'>{ user.ensLabel || shortenHex(user.address, 4) }</h3>
